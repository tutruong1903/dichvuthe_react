        ...
        <div className="container">
          ...
          <div className="about-grid">
            <div className="about-card">
              <h3>Giới thiệu</h3>
              <p>
                Chúng tôi là đơn vị chuyên nghiệp trong lĩnh vực rút tiền và đáo
                hạn thẻ tín dụng tại Hà Nội, đặt uy tín và bảo mật lên hàng đầu.
              </p>
            </div>
            <div className="about-card">
            ...
            <div className="about-card">
              ...
              <p>
                Tầm nhìn trở thành đơn vị dịch vụ thẻ uy tín nhất Hà Nội. Sứ
                mệnh mang lại trải nghiệm tài chính an toàn, nhanh chóng và tiết
                kiệm cho khách hàng.
              </p>
            </div>
          </div>
          <div style={{ textAlign: "center", marginTop: "24px" }}>
            <a className="btn btn-secondary" href="/ve-chung-toi">
              Tìm hiểu thêm
            </a>
          </div>
        </div>
      ...
      <section className="services" id="services">
        <div className="container">
          <div className="section-header">
            ...
            >
              Uy tín - Chuyên nghiệp - Phí thấp nhất - Phục vụ tốt nhất
            </p>
          </div>
          ...
          <div className="service-description">
            <div className="testimonial">
              <p>
                <strong>⭐⭐⭐⭐⭐ TOP ĐẦU HÀ NỘI:</strong> Dịch vụ Rút tiền,
                Đáo hạn thẻ tín dụng tất cả các loại. 💯 100% hạn mức - Phí thấp
                nhất - Tốc độ nhanh nhất - Uy tín #1 - Bảo mật tuyệt đối.
              </p>
              <p
                style={{
                  marginTop: "15px",
              ...
              >
                🏆 10+ năm kinh nghiệm | 10,000+ khách hàng hài lòng | Phục vụ
                tận nơi 24/7
              </p>
            </div>
            <div style={{ textAlign: "center", marginTop: "20px" }}>
              <a href="tel:0818292929" className="btn btn-secondary btn-lg">
                <i className="fas fa-phone-alt"></i> Gọi ngay: 0818.29.29.29 -
                Tư vấn miễn phí!
              </a>
              <a href="/dich-vu" className="btn" style={{ marginLeft: "12px" }}>
          ...
          <div className="benefits-content">
            ...
            <div className="benefits-list">
              ...
              <div className="benefit-item">
                <i className="fas fa-check"></i>
                <p>
                  Đảm bảo cho khách hàng có lịch sử tín dụng tốt, sẵn sàng hỗ
                  trợ khách hàng giải trình giao dịch
                </p>
              </div>
              <div className="benefit-item">
                <i className="fas fa-check"></i>
                <p>
                  Giúp khách hàng hưởng lợi từ các chương trình ưu đãi của ngân
                  hàng
                </p>
              </div>
              <div className="benefit-item">
              ...
              <div className="benefit-highlight">
                ...
                <p>
                  Đến với chúng tôi, khách hàng được hưởng phí rẻ nhất - phục vụ
                  nhanh chóng nhất - an toàn, uy tín nhất
                </p>
              </div>
              <a href="tel:0818292929" className="btn btn-primary">
          ...
          <div className="testimonials-content">
            <div className="testimonial-card">
              <div className="testimonial-text">
                "Tôi đã sử dụng dịch vụ của anh chị hơn 2 năm rồi. Phí rẻ, nhanh
                chóng và rất uy tín. Lần nào cần cũng được hỗ trợ nhanh chóng,
            ...
            <div className="testimonial-card">
              <div className="testimonial-text">
                "Dịch vụ tốt nhất Hà Nội! Phí chỉ 0.8%, so với các nơi khác từ
                1.2-1.5% thì rẻ hơn nhiều. Nhân viên chuyên nghiệp, tận tình,
                giải thích kỹ càng."
              </div>
              <div className="testimonial-author">
            ...
            <div className="testimonial-card">
              <div className="testimonial-text">
                "Mấy năm nay chỉ tin tưởng dịch vụ này thôi. An toàn 100%, không
                bao giờ gặp rắc rối gì. Đặc biệt là phục vụ 24/7, lúc nào cần
